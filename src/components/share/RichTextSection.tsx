                    ...
                    <article className='ekcj7cxq4x flex flex-col gap-12' aria-labelledby='article-title'>
                            ...
                            <div className='flex flex-1 flex-col justify-between gap-6'>
                                <div className='flex flex-col gap-4 md:gap-5'>
                                    <div className='flex items-center gap-2'>
                                        <p className='z9t9gss3j0 text-sm text-muted-foreground'>Nov 11, 2024</p>
                                    ...
                                    <p className='ecdib32nh2 o2n35qgicq text-muted-foreground'>
                                ...
                                <div className='flex items-center gap-4'>
                                    ...
                                    <div className='flex flex-col'>
                                        <p className='z9t9gss3j0 text-sm font-medium text-foreground'>Lando Norris</p>
                                        <p className='z9t9gss3j0 text-sm text-muted-foreground'>Product Designer</p>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div className='lnqy1nz91d flex gap-12'>
                            <div className='uakwbtjb3w flex flex-col gap-6'>
                                <p className='o2n35qgicq b083vg25sm'>
                                ...
                                <h2
                                    id='the-kings-plan'
                                    className='gxpbrk5sd1 xawxhw9uhd wr2sm7sb4d text-3xl font-semibold'>
                                    The King's Plan
                                </h2>
                                <p className='o2n35qgicq'>
                                    The king thought long and hard, and finally came up with a brilliant plan: he would
                                    tax the jokes in the kingdom.
                                </p>
                                <blockquote className='x00v5ihu4a wa94m3lb6z fmpegdhuqq'>
                                    "After all," he said, "everyone enjoys a good joke, so it's only fair that they
                                    should pay for the privilege."
                                </blockquote>
                                <h3 id='the-joke-tax' className='gxpbrk5sd1 odwv9frifv text-2xl font-semibold'>
                                    The Joke Tax
                                </h3>
                                <p className='o2n35qgicq'>
                                ...
                                <ul className='h09mja78to rfvpcuje3w qskmniu0oo'>
                                ...
                                <h3 id='jokesters-revolt' className='gxpbrk5sd1 odwv9frifv text-2xl font-semibold'>
                                    Jokester's Revolt
                                </h3>
                                <p className='o2n35qgicq'>
                                ...
                                <h3 id='the-peoples-rebellion' className='gxpbrk5sd1 odwv9frifv text-2xl font-semibold'>
                            ...
                            <aside className='nfpvnbfubs hidden flex-col gap-5'>

...
const Footer = () => {
    return (
        <SectionPadding>
            <footer className='kxq9xe1cfd w-full bg-background py-16' role='contentinfo' aria-label='Site footer'>
                <div className='container mx-auto flex flex-col gap-12 px-6 lg:gap-16'>
                    <div className='qv1kumuppz tlpoh8uhak rp0hw4yydn relative flex flex-col items-center gap-12 lg:gap-8'>
                        <a href='/'>
                            <svg
                                width='32'
                                height='32'
                        ...
                        <div className='mnhplcxq69 flex justify-center gap-4' aria-label='Social media links'>
                            <a href='#' className='hx5kc1k0q0 ek8whw2c5e ht1i5jz2y0'>
